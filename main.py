...
def analyze_with_gpt(title, snippet, link):
    ...
    Завдання:
    1️⃣ Визнач справжню назву компанії, якщо можливо
    2️⃣ Чи може це бути потенційний клієнт? (Так / Ні + коротке пояснення)
...
if start and query:
    ...
    with st.spinner("Пошук та GPT-аналіз..."):
        ...
        st.success(f"✅ Дані збережено до вкладки '{tab_name}' (відфільтровано по 'Клієнт: Так')")
