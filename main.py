    ...
    with st.spinner("Проводиться GPT-аналіз..."):
        ...
        for idx, row in enumerate(records, start=2):
            ...
            try:
                ...
                www.xraymedem.com
                Виробники продукцію яких ми продаємо та їхні офіційні дистрибютори (типу Fujifilm Europe) - не є потенційними
...
1. Визнач категорію компанії: Medical, NDT або Other (NDT також перспективно) 
